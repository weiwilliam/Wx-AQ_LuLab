...
# ENS_ROOT = path where ensemble background files exist
  ANAL_TIME=${1}
  RUN_NAME=${2} #realtime
  JOB_DIR=${3} #/network/rit/home/dg771199/WRF-GSI/run/ #src/GSI/run
     #normally you put run scripts here and submit jobs form here, require a copy of gsi.x at this directory
  OBS_ROOT=${4} #/network/rit/home/dg771199/WRF-GSI/dat
  BK_ROOT=${5} #/network/rit/home/dg771199/WRF-GSI/src/WRF
...
#  PREPBUFR=${OBS_ROOT}/rap.t${HH}z.prepbufr.tm00
  PREPBUFR=${OBS_ROOT}/prepbufr.gdas.20180714.t${HH}z.nr
  BK_FILE=${BK_ROOT}/wrfout_d01_2018-07-14_${HH}:00:00
#
#------------------------------------------------
